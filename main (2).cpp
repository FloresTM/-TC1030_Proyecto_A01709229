...
int main()
{
    int inputUsuarioAtaque;
    int inputUsuarioDefensa;
    int inputUsuario;
    int contador = 0;
    ...
    if(inputUsuario == 1){
        ...
        for (int i = 0; i<5; i++){
            if (naves[i].getPiloto().getEnergiaPiloto() <= 2){
                    cout << "el piloto de la nave " 
                    // naves[i]
                    << "uso botiquin su nueva vida es de: ";
        ...
        Missil missil1(19,90);
        missil1.mostrarMissil();
        Ametralladora ametralladora1(10,70);
        ametralladora1.mostrarAmetralladora();
    }
